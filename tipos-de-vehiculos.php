...
<html lang="en">
  <head>
    ...
    <meta name="copyright" content="J.H.H S.A.C." />    
    <meta name="description" content=" en Lima - Perú">
    <meta name="keywords" content="Somos una Empresa legalmente constituida dedicada a la compra y venta de vehículos nuevos y seminuevos, tenemos mas de 5 años dedicados a este rubro vende tu vehículo en menos de 2 horas.">
  ...
  <!--<div class="slider bg-navy-blue bg-scroll pos-rel breadcrumbs-page">
    <div class="container">      
      <div class="breadcrumbs-description">
        <h1>Nosotros</h1>
        Valoramos las iniciativas individuales y colectivas de organizaciones productivas y educativas y ponemos a su disposición el: Asesoramiento, Equipamiento, Mantenimiento, Calibración, de Equipos: de Ingeniería, Médicos y Laboratorios de Investigación e Instrucción Educativa.
      </div>
    </div>
  </div>-->
                    ...
                    <div class="col-md-12 ml-auto why-choose wow fadeInRight" data-wow-duration="0" data-wow-delay="0.6s">
                        <div class="row">                 
                              <!--<div class="col-12 col-lg-6">              
                                <img nonce="<?php echo _SYSTEM_NONCE_; ?>" id="tnos" src="<?php echo URL_SITE; ?>/images/nosotros-1.png"/>
                              </div>-->
                              <!--<div class="col-12 col-lg-6">              
                                <div class="icon-box-2">
                                  <div class="media">                     
                                      <div class="service-inner-content media-body">
                                          ...
                                          <p><strong>NUESTRA MISIÓN:</strong> Ser la empresa líder en la implementación de equipos de laboratorio y médicos con el mejor soporte técnico.</p>
                                          <p><strong>NUESTRA VISIÓN:</strong> Participar activamente en el resurgimiento de Empresas, Instituciones y clientes, apoyándolos en su acreditación y certificación normada Nacional e Internacionalmente.</p>
                                          <p><strong>NUESTROS VALORES:</strong> Promover;  Honestidad, Integridad, Fidelidad, Dignidad y Lealtad en nuestro equipo como modelo de trabajo que refleja un estado de servicio en mercados sostenibles.</p>
                                      </div>
                                  </div>
                                </div>              
                              </div>-->
                              <div class="col-12 text-center my-4">
                                 <video id='MyVideo' width="1000" height="600" controls autoplay="true">
                                   <source src="./videos/JHH.mp4" type="video/mp4" >
                                    <script>
                                      let options = {
                                          root: null,
                                          rootMargin:'0px',
