...
<html lang="en">
  <head>
    ...
    <title>Equipos Médicos / Cooling Equipment / PSS</title>    
  ...
  <div class="slider bg-navy-blue bg-scroll pos-rel breadcrumbs-page">
    <div class="container">      
      <div class="breadcrumbs-description">
        <h1>Productos</h1>
        EQUIPOS MÉDICOS: COOLING EQUIPMENT
      </div>
    </div>
  </div>
          ...
          <div class="col-md-12 ml-auto why-choose wow fadeInRight" data-wow-duration="0" data-wow-delay="0.6s">
              ...
              <section class="bg-white wide-tb-50 bg-wave">
                <div class="container">
                      ...
                      <h3 class="h3-sm fw-6 txt-blue mb-4">PRODUCTOS / EQUIPOS MÉDICOS / COOLING EQUIPMENT</h3>  
                      
                      <div class="row">
                          <div class="col-lg-4">  
                              <div class="boxmarcas">
                                 <a href="https://www.labotronics.com/Cooling-Equipment" target="_blank"><img src="images/labotronics.png" alt=""/></a>
                                 <a href="https://www.labotronics.com/Cooling-Equipment" target="_blank" class="btn">Labotronics</a>
                              </div> 
                          </div>
                      ...
                      <div class="row">
                          <div class="col-lg-4">
                               <ul class="list-unstyled icons-listing mb-0">                                    
                                    <li><i class="icofont-check"></i> Banco Refrigerado de Sangre</li>
                                    <li><i class="icofont-check"></i> Congelador de Plasma</li>
                                    <li><i class="icofont-check"></i> Incubadora de Plaquetas de Sangre</li>
                                    <li><i class="icofont-check"></i> Enfriador</li>
                              </ul>
                          </div>
                          <div class="col-lg-4">
                              <ul class="list-unstyled icons-listing mb-0">
                                    <li><i class="icofont-check"></i> Almacén refrigerado</li>                                   
                                    <li><i class="icofont-check"></i> Baño de frio</li>
                                    <li><i class="icofont-check"></i> Congelador</li>
                                    <li><i class="icofont-check"></i> Fábrica de Hielo</li>
                              </ul>
                          </div>
                          <div class="col-lg-4">
                              <ul class="list-unstyled icons-listing mb-0">
                                    <li><i class="icofont-check"></i> Refrigerador Farmacéutico</li>
                                    <li><i class="icofont-check"></i> Recirculador Refrigerado</li>
                              </ul>  
                          </div>     
                      </div>                
                      ...
                      <div class="row">
                          <div class="col-lg-4 text-center">
                               <img src="images/equipos-medicos/producto-image059.png" alt="">
                          </div>
                          <div class="col-lg-8">                             
                               <p>El refrigerador de banco de sangre LB-10BSR es un refrigerador controlado con microprocesador en posición vertical debajo de la puerta de vidrio. El enfriamiento por aire forzado provoca una circulación de aire uniforme para un flujo de aire optimizado. La plataforma con estantes de acero inoxidable con cubierta de plexiglás promueve el almacenamiento organizado que permite el acceso visual directo de las bolsas de sangre. Los ciclos de descongelación automatizados facilitan el almacenamiento interior sin heladas. El aislamiento de doble acristalamiento con junta magnética garantiza un bajo consumo de energía. Las alarmas del sistema incluyen límites de temperatura, puerta entreabierta, bajo voltaje y condiciones de apagado.</p>
                          </div>     
                      </div>                          
