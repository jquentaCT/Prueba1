...
<html lang="en">
  <head>
    ...
    <title>Equipos Médicos / Microbiología / PSS</title>    
          ...
          <div class="col-md-12 ml-auto why-choose wow fadeInRight" data-wow-duration="0" data-wow-delay="0.6s">
              ...
              <section class="bg-white wide-tb-50 bg-wave">
                <div class="container">
                      ...
                      <h3 class="h3-sm fw-6 txt-blue mb-4">PRODUCTOS / EQUIPOS MÉDICOS / MICROBIOLOGÍA</h3>  
                      
                      <div class="row">
                          <div class="col-lg-4">  
                              <div class="boxmarcas">
                                 <a href="https://www.labotronics.com/Microbiology" target="_blank"><img src="images/labotronics.png" alt=""/></a>
                                 <a href="https://www.labotronics.com/Microbiology" target="_blank" class="btn">Labotronics</a>
                              </div> 
                          </div>
                      ...
                      <div class="row">
                          <div class="col-lg-4">
                               <ul class="list-unstyled icons-listing mb-0">                                    
                                    <li><i class="icofont-check"></i> Sistema automatizado de hemocultivo</li>
                                    <li><i class="icofont-check"></i> Esterilizador de Azas</li>
                                    <li><i class="icofont-check"></i> Molino Laminador de Bolas</li>
                                    <li><i class="icofont-check"></i> Centrifuga</li>
                                    <li><i class="icofont-check"></i> Contador de Colonias</li>
                                    <li><i class="icofont-check"></i> Cabina de Secado</li>
                                    <li><i class="icofont-check"></i> Fermentador</li>
                                    <li><i class="icofont-check"></i> Reactor de Vidrio</li>
                                    <li><i class="icofont-check"></i> Sistema de limpieza GPC</li>                                                                             
                               </ul>
                          </div>
                          <div class="col-lg-4">
                               <ul class="list-unstyled icons-listing mb-0">                                    
                                    <li><i class="icofont-check"></i> Homogeneizador</li>
                                    <li><i class="icofont-check"></i> Inspisator</li>
                                    <li><i class="icofont-check"></i> Pruebas con Jarra</li>
                                    <li><i class="icofont-check"></i> Agitadores de Laboratorio</li>
                                    <li><i class="icofont-check"></i> Muestra de aire microbiano</li>
                                    <li><i class="icofont-check"></i> Sistema de digestión por microondas</li>
                                    <li><i class="icofont-check"></i> Reactor por Microondas</li>
                                    <li><i class="icofont-check"></i> Sintetizador microondas</li>
                                    <li><i class="icofont-check"></i> Estación de trabajo de microondas</li>                                                                          
                               </ul>
                          </div>
                          <div class="col-lg-4">
                               <ul class="list-unstyled icons-listing mb-0">                                    
                                    <li><i class="icofont-check"></i> Mezcladores y Vórtice</li>
                                    <li><i class="icofont-check"></i> Agitador Aéreo</li>
                                    <li><i class="icofont-check"></i> Estación de Trabajo para patología</li>
                                    <li><i class="icofont-check"></i> Muestre ador de polvo portátil</li>
                                    <li><i class="icofont-check"></i> Evaporador Rotatorio</li>
                                    <li><i class="icofont-check"></i> Concentrador de Muestras</li>
                                    <li><i class="icofont-check"></i> Cabina Germinadora</li>
                                    <li><i class="icofont-check"></i> Mezcladora estomacher</li>                                                                           
                               </ul>
                          </div>     
                      </div>
                      ...
                      <div class="row">
                          <div class="col-lg-4 text-center">
                               <img src="images/equipos-medicos/producto-image061.png" alt="">
                          </div>
                          <div class="col-lg-8">
                               <p>&nbsp;</p>                             
                               <p>El sistema de digestión por microondas LB-C10MDS es una unidad de acero inoxidable controlada por PID construida por soldadura láser sin costura. Reflexión de microondas en el techo y técnica de guía para mejorar la densidad de microondas y la eficiencia de calentamiento. Cuenta con sistema de bloqueo automático que asegura la puerta durante la digestión. Tiene múltiples módulos de aplicación como digestión, extracción, síntesis, desecación, combustión de oxígeno e hidrólisis de proteínas.</p>
                          </div>     
                      </div>                          
