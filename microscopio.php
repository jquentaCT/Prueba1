...
<html lang="en">
  <head>
    ...
    <title>Equipos Médicos / Microscopio / PSS</title>    
          ...
          <div class="col-md-12 ml-auto why-choose wow fadeInRight" data-wow-duration="0" data-wow-delay="0.6s">
              ...
              <section class="bg-white wide-tb-50 bg-wave">
                <div class="container">
                      ...
                      <h3 class="h3-sm fw-6 txt-blue mb-4">PRODUCTOS / EQUIPOS MÉDICOS / MICROSCOPIO</h3>  
                      
                      <div class="row">
                          <div class="col-lg-4">  
                              <div class="boxmarcas">
                                 <a href="https://www.labotronics.com/Microscopy/Microscope" target="_blank"><img src="images/labotronics.png" alt=""/></a>
                                 <a href="https://www.labotronics.com/Microscopy/Microscope" target="_blank" class="btn">Labotronics</a>
                              </div> 
                          </div>
                          <div class="col-lg-4">
                              <div class="boxmarcas">
                                 <a href="https://www.humboldtmfg.com/?act=search&query=MICROSCOPE" target="_blank"><img src="images/humboldt.png" alt=""/></a>
                                 <a href="https://www.humboldtmfg.com/?act=search&query=MICROSCOPE" target="_blank" class="btn">Humboldt</a>
                              </div>
                          </div>
                      ...
                      <div class="row">
                          <div class="col-lg-4">
                               <ul class="list-unstyled icons-listing mb-0">                                    
                                    <li><i class="icofont-check"></i> Microscopio</li>                                                                                                                
                               </ul>
                          </div>
                          <div class="col-lg-4"></div>
                          <div class="col-lg-4"></div>     
                      ...
                      <div class="row">
                          <div class="col-lg-4 text-center">
                               <img src="images/equipos-medicos/producto-image049.png" alt="">
                          </div>
                          <div class="col-lg-8">
                               <p>&nbsp;</p>                             
                               <p>El microscopio biológico invertido LB-11IVBM es un instrumento con un objetivo de larga distancia de trabajo (LWD) optimizado para una visualización más plana y brillante. El sistema de iluminación de la lámpara halógena permite la visualización de muestras con sus colores naturales. Varios accesorios opcionales actualizan la unidad y la hacen más flexible para aplicaciones avanzadas.</p>
                          </div>     
                      </div>                          
