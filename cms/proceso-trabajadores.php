...
$apellido = htmlspecialchars(clear_space(not_html_script($apellido)));
$cargo = htmlspecialchars(clear_space(not_html_script($cargo)));
...
if( !empty($action) ){
    ...
    if( strlen($apellido) <=2 ){ $e2 = '(*) Ingrese su apellido completo.'; $encontro = 1; }
    else{
        if(caracteres_special($apellido) == '_INCORRECTO_'){ 
            $e2 = '(*) Prohibido caracteres extra&ntilde;os.'; $encontro = 1; 
        }
    } 

    if( strlen($cargo) <=2 ){ $e3 = '(*) Ingrese el cargo.'; $encontro = 1; }
    else{
        if(caracteres_special($cargo) == '_INCORRECTO_'){ 
            $e3 = '(*) Prohibido caracteres extra&ntilde;os.'; $encontro = 1; 
        }
    }
    
    if(onlynumbers($mostrar) == '_INCORRECTO_'){ $e4 = '(*) Formato incorrecto.'; $encontro = 1; }
    elseif($mostrar!='1' && $mostrar!='2'){ $e4 = '(*) ID desconocido.'; $encontro = 1; }
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">MODIFICAR EJECUTIVO DE VENTAS</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="./">Home</a></li>
                        <li class="breadcrumb-item">M&oacute;dulos</li>
                        <li class="breadcrumb-item active">Ejecutivos de Ventas</li>
                    </ol>
                </div>
                <div class="">
...
<?php
  if($v=='borrar' && !empty($cod)){
     ...
     $info = $conectdata->get_data_trabajadores($cod);

     $xmod = $PanelModulo;
     $xid = $datauser['idu']; 
     $xdes = "Eliminación de EJECUTIVO DE VENTAS: ".utf8_encode($info['nombre']);
     $xip = getIP();
     $xnav = my_browser();
     $xsis = my_system_pc();
     //$xurl = obtener_url();
     ...
     $conectdata->set_delete_trabajadores($cod);
     ...
     window.location.href = './registrar-trabajadores.php';
     </script>";
...
?>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <a href="./lista-trabajadores.php" class="btn btn-info" role="button" style="margin-bottom: 5px;">Ver lista de Ejecutivos de Ventas</a>                        
                            ...
                            <div class="card-body">
                                ...
                                if( !empty($action) ){
                                    ...
                                    if($encontro == '0'){ 
                                         ...
                                         $variables[0] = $nombre;
                                         $variables[1] = $apellido;                                        
                                         $variables[2] = $cargo;                                               
                                         $variables[3] = $mostrar;

                                         $p = $conectdata->set_update_trabajadores($cod,$variables);
                                ...
                                $data = $conectdata->get_data_trabajadores($cod);     
                                ?>
                                ...
                                <form class="form p-t-20" action="./proceso-trabajadores.php?v=editar&cod=<?php echo $cod; ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="col-lg-6">
                                          <div class="form-group<?php if(!empty($e2)){echo ' has-danger';} ?>">
                                            ...
                                            <input type="text" name="apellido" class="form-control" id="input_apellido" maxlength="80" value="<?php echo $data['apellidos']; ?>" placeholder="Apellido completo">
                                  ...
                                  <div class="form-group<?php if(!empty($e3)){echo ' has-danger';} ?>">
                                      <label for="input_cargo">Cargo: <span class="text-danger">(*)</span></label>                                          
                                      <input type="text" name="cargo" class="form-control" id="input_cargo" maxlength="100" value="<?php echo $data['cargo']; ?>" placeholder="Ingrese el cargo">
                                  ...
                                  <div class="form-group<?php if(!empty($e4)){echo ' has-danger';} ?>">
                                    ...
                                    <div class="input-group">
                                      <ul class="icheck-list form-check-inline">
                                          <li>
                                              <input type="radio" class="check" id="mo1" name="mostrar" value="1" data-radio="iradio_square-red"<?php if( $data['mostrar']=='1' ){echo ' checked';} ?>>
                                              <label for="mo1"><strong>SI</strong> &nbsp;</label>
                                          </li>
                                          <li>
                                              <input type="radio" class="check" id="mo2" name="mostrar" value="2" data-radio="iradio_square-red"<?php if( $data['mostrar']=='2' ){echo ' checked';} ?>>
                                              <label for="mo2"><strong>NO</strong> &nbsp;</label>
                                          </li>
                                      </ul>
                                     </div>
