        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">REGISTRAR EJECUTIVO DE VENTAS</h3>
                </div>
                            ...
                            <div class="card-body">
                                ...
                                if( !empty($action) ){
                                    ...
                                    if($encontro == '0'){                                         
                                         ...
                                         $p = $conectdata->set_grabar_trabajadores($variables);                                        
                                         if($p==true){
                                ...
                                <form class="form p-t-20" action="" method="post" enctype="multipart/form-data" autocomplete="off">
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="col-lg-6">
                                        <div class="form-group<?php if(!empty($e2)){echo ' has-danger';} ?>">
                                            ...
                                            <input type="text" name="apellido" class="form-control" id="input_apellido" maxlength="80" value="<?php echo $apellido; ?>" placeholder="Apellido completo">
                                  ...
                                  <div class="form-group<?php if(!empty($e3)){echo ' has-danger';} ?>">
                                      ...
                                      <input type="text" name="cargo" class="form-control" id="input_cargo" maxlength="100" value="<?php echo $cargo; ?>" placeholder="Ingrese el cargo">
                                  ...
                                  <div class="form-group<?php if(!empty($e4)){echo ' has-danger';} ?>">
                                    ...
                                    <div class="input-group">
                                      <ul class="icheck-list form-check-inline">
                                          <li>
                                              <input type="radio" class="check" id="mo1" name="mostrar" value="1" data-radio="iradio_square-red"<?php if(empty($mostrar) or $mostrar=='1'){echo ' checked';} ?>>
                                              <label for="mo1"><strong>SI</strong> &nbsp;</label>
                                          </li>
                                          <li>
                                              <input type="radio" class="check" id="mo2" name="mostrar" value="2" data-radio="iradio_square-red"<?php if($mostrar=='2'){echo ' checked';} ?>>
