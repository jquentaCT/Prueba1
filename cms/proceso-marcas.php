        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">MODIFICAR MARCA</h3>
                </div>
...
<?php
  if($v=='borrar' && !empty($cod)){
     ...
     $info = $conectdata->get_data_marca($cod);

     $xmod = $PanelModulo;
     $xid = $datauser['idu']; 
     $xdes = "Eliminación de MARCA: ".utf8_encode($info['nombre']);
     $xip = getIP();
     $xnav = my_browser();
     $xsis = my_system_pc();
     //$xurl = obtener_url();
     ...
     $conectdata->set_delete_marca($cod);
     ...
     window.location.href = './registrar-marcas.php';
     </script>";
                            ...
                            <div class="card-body">
                                ...
                                if( !empty($action) ){
                                    ...
                                    if($encontro == '0'){ 
                                         ...
                                         $p = $conectdata->set_update_marca($cod,$variables);
                                ...
                                $data = $conectdata->get_data_marca($cod);     
                                ?>
                                ...
                                <form class="form p-t-20" action="./proceso-marcas.php?v=editar&cod=<?php echo $cod; ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                                  ...
                                  <div class="text-center">
                                     ...
                                     <img src="../images/marcas/<?php echo $_img1_; ?>" class="img-fluid shadow m10" alt="IMAGEN MARCA"/>                                     
                                  </div>
                                  <hr>
                                  <br>

                                  <input type="hidden" name="action" value="send"/>
                                  <button type="submit" class="btn btn-info waves-effect waves-light m-r-10"><i class="fa fa-check"></i> Modificar marca</button>
