...
$sexo = clear_space(not_html_script(limpiar($sexo)));
...
if( !empty($action) ){
    ...
    if( strlen($resumen) <=2 ){ $e2 = '(*) Ingrese el comentario del cliente.'; $encontro = 1; }
    else{
        if(caracteres_area($resumen) == '_INCORRECTO_'){ $e2 = '(*) Prohibido caracteres extra&ntilde;os.'; $encontro = 1; }
    }
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">MODIFICAR CLIENTE SATISFECHO</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="./">Home</a></li>
                        <li class="breadcrumb-item">M&oacute;dulos</li>
                        <li class="breadcrumb-item active">Clientes satisfechos</li>
                    </ol>
                </div>
                <div class="">
...
<?php
  if($v=='borrar' && !empty($cod)){
     ...
     $info = $conectdata->get_data_satisfecho($cod);

     $xmod = $PanelModulo;
     $xid = $datauser['idu']; 
     $xdes = "Eliminación de SATISFACCIÓN: ".utf8_encode($info['nombre']);
     $xip = getIP();
     $xnav = my_browser();
     $xsis = my_system_pc();
     //$xurl = obtener_url();
     ...
     $conectdata->set_delete_satisfecho($cod);
     ...
     window.location.href = './registrar-satisfechos.php';
     </script>";
...
?>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <a href="./lista-satisfechos.php" class="btn btn-info" role="button" style="margin-bottom: 5px;">Ver lista de clientes satisfechos</a>                        
                            ...
                            <div class="card-body">
                                ...
                                if( !empty($action) ){
                                    ...
                                    if($encontro == '0'){ 
                                         ...
                                         $p = $conectdata->set_update_satisfecho($cod,$variables);
                                ...
                                $data = $conectdata->get_data_satisfecho($cod);     
                                ?>
                                ...
                                <form class="form p-t-20" action="./proceso-satisfechos.php?v=editar&cod=<?php echo $cod; ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                                  ...
                                  <div class="form-group<?php if(!empty($e2)){echo ' has-danger';} ?>">
                                      ...
                                      <textarea name="resumen" class="form-control alert-info" id="text_resumen" rows="3" placeholder="Ingrese el comentario" maxlength="170"><?php echo $data['comentarios']; ?></textarea>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="input-group">
                                      <ul class="icheck-list form-check-inline">
                                          <li>
                                              <input type="radio" class="check" id="sexo1" name="sexo" value="1" data-radio="iradio_square-red"<?php if( $data['sexo']=='1' ){echo ' checked';} ?>>
                                              <label for="sexo1"><strong>Masculino</strong> &nbsp;</label>
                                          </li>
                                          <li>
                                              <input type="radio" class="check" id="sexo2" name="sexo" value="2" data-radio="iradio_square-red"<?php if( $data['sexo']=='2' ){echo ' checked';} ?>>
                                              <label for="sexo2"><strong>Femenino</strong> &nbsp;</label>
                                          </li>
                                      </ul>
                                     </div>
                                  </div>
                                  ...
                                  <button type="submit" class="btn btn-info waves-effect waves-light m-r-10"><i class="fa fa-check"></i> Modificar satisfacción</button>
