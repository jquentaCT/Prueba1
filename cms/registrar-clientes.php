        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">REGISTRAR CLIENTE</h3>
                </div>
                            ...
                            <div class="card-body">
                                ...
                                if( !empty($action) ){
                                    ...
                                    if($encontro == '0'){                                         
                                         ...
                                         $p = $conectdata->set_grabar_cliente($variables);                                        
                                         if($p==true){
                                ...
                                <form class="form p-t-20" action="" method="post" enctype="multipart/form-data" autocomplete="off">
                                  ...
                                  <button type="submit" class="btn btn-info waves-effect waves-light m-r-10"><i class="fa fa-check"></i> Registrar cliente</button>
