        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">REGISTRAR CLIENTE SATISFECHO</h3>
                </div>
                            ...
                            <div class="card-body">
                                ...
                                if( !empty($action) ){
                                    ...
                                    if($encontro == '0'){                                          
                                         ...
                                         $p = $conectdata->set_grabar_satisfecho($variables);                                                                                 
                                         if($p==true){                                              
                                ...
                                <form class="form p-t-20" action="" method="post" enctype="multipart/form-data" autocomplete="off">
                                  ...
                                  <div class="form-group<?php if(!empty($e2)){echo ' has-danger';} ?>">
                                      ...
                                      <textarea name="resumen" class="form-control alert-info" id="text_resumen" rows="3" placeholder="Ingrese el comentario" maxlength="170"><?php echo $resumen; ?></textarea>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="input-group">
                                      <ul class="icheck-list form-check-inline">
                                          <li>
                                              <input type="radio" class="check" id="sexo1" name="sexo" value="1" data-radio="iradio_square-red"<?php if(empty($sexo) or $sexo=='1'){echo ' checked';} ?>>
                                              <label for="sexo1"><strong>Masculino</strong> &nbsp;</label>
                                          </li>
                                          <li>
                                              <input type="radio" class="check" id="sexo2" name="sexo" value="2" data-radio="iradio_square-red"<?php if($sexo=='2'){echo ' checked';} ?>>
                                  ...
                                  <button type="submit" class="btn btn-info waves-effect waves-light m-r-10"><i class="fa fa-check"></i> Registrar satisfacción</button>
