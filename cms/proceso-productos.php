...
<?php
  if($v=='borrar' && !empty($cod)){
     ...
     $info = $conectdata->get_data_producto($cod);
     ...
     $conectdata->set_delete_producto($cod);
...
?>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <a href="./lista-productos.php" class="btn btn-info" role="button" style="margin-bottom: 5px;">Ver lista de productos</a>                        
                            ...
                            <div class="card-body">
                                ...
                                if( !empty($action) ){
                                    ...
                                    if($encontro == '0'){ 
                                         ...
                                         $p = $conectdata->set_update_producto($cod,$variables);
                                ...
                                $data = $conectdata->get_data_producto($cod);     
                                ?>
                                ...
                                <form class="form p-t-20" action="./proceso-productos.php?v=editar&cod=<?php echo $cod; ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                                  
                                  <div class="row">
                                      <div class="col-md-3">
                                        <div class="form-group<?php if(!empty($e0)){echo ' has-danger';} ?>">
                                            <label for="input_codigogd">Código: <span class="text-danger">(*)</span></label>                                          
                                            <input type="text" name="codigogd" class="form-control" id="input_codigogd" maxlength="15" value="<?php echo $data['codigo']; ?>" placeholder="Código del producto">
                                  ...
                                  <div class="form-group<?php if(!empty($e3)){echo ' has-danger';} ?>">
                                      ...
                                      <textarea name="resumen" class="form-control alert-info" id="text_resumen" rows="5" placeholder="Ingrese el resumen" maxlength="450"><?php echo $data['resumen']; ?></textarea>
                                  ...
                                  <div class="form-group<?php if(!empty($e4)){echo ' has-danger';} ?>">
                                      ...
                                      <textarea name="contenido" class="textarea_cont form-control alert-info" id="text_cont" rows="15" placeholder="Ingrese el contenido completo"><?php echo $data['descripcion']; ?></textarea>
                                  ...
                                  <div class="form-group<?php if(!empty($e11)){echo ' has-danger';} ?>">
                                      ...
                                      <div class="input-group">
                                          <select name="marca" class="selectpicker m-b-20 m-r-10" id="select_marca" data-style="btn-danger">
                                              ...
                                              <?php                                              
                                                $conectdata->set_listar('select idm, nombre from '.TABLE_PREFIX._TAB_MARC_SYS_.' order by nombre asc',$data['marcas']); 
                                              ?>                                             
                                          </select>
                                      </div>
                                  ...
                                  <div class="style-select form-group<?php if(!empty($e5)){echo ' has-danger';} ?>">          
                                        ...
                                        <div class="subject-info-box-1">                
                                          <label class="control-label" for="list_categoria1">Categorías: <span class="text-danger">(*)</span></label>
                                          <select name="list_categoria1[]" multiple class="form-control" id="list_categoria1">                  
                                            <?php
                                                if(count($list_genero2)==0){ 
                                                   if(!empty($data['categorias'])){ $line = "select * from ".TABLE_PREFIX._TAB_CATP_SYS_." where idc not in(".$data['categorias'].") order by nombre asc"; }
                                                   else{ $line = "select * from ".TABLE_PREFIX._TAB_CATP_SYS_." order by nombre asc"; }
                                                }
                                        ...
                                        <div class="subject-info-box-2">               
                                            ...
                                            <select name="list_categoria2[]" multiple class="form-control" id="list_categoria2">
                                             <?php
                                                if(count($list_categoria2)>0){ $line = "select * from ".TABLE_PREFIX._TAB_CATP_SYS_." where idc in(".$lista.")"; }
                                                else{ $line = "select * from ".TABLE_PREFIX._TAB_CATP_SYS_." where idc in(".$data['categorias'].")"; }
                                  ...
                                  <div class="form-group<?php if(!empty($e6)){echo ' has-danger';} ?>">
                                      ...
                                      <input type="text" name="precio" class="form-control" id="precio" maxlength="15" value="<?php echo $data['precio']; ?>" placeholder="0.00">
                                  ...
                                  <div class="form-group<?php if(!empty($e7)){echo ' has-danger';} ?>">
                                      ...
                                      <input id="stock" type="text" value="<?php echo $data['stock']; ?>" name="stock" data-bts-button-down-class="btn btn-secondary btn-outline" data-bts-button-up-class="btn btn-secondary btn-outline" maxlength="10" onkeypress="return valnumero(event)" placeholder="0"/>
                                  ...
                                  <div class="form-group<?php if(!empty($e8)){echo ' has-danger';} ?>"> 
                                    ...
                                    <input type="text" name="etiquetas" value="<?php echo $data['etiquetas']; ?>" class="form-control alert-info" id="input_tags" data-role="tagsinput" placeholder="Añadir etiquetas">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="input-group">
                                      <ul class="icheck-list form-check-inline">
                                          <li>
                                              <input type="radio" class="check" id="carrusel1" name="carrusel" value="1" data-radio="iradio_square-red"<?php if( $data['home']=='1' ){echo ' checked';} ?>>
                                              <label for="carrusel1"><strong>SI</strong> &nbsp;</label>
                                          </li>
                                          <li>
                                              <input type="radio" class="check" id="carrusel2" name="carrusel" value="2" data-radio="iradio_square-red"<?php if( $data['home']=='2' ){echo ' checked';} ?>>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="input-group">
                                      <ul class="icheck-list form-check-inline">
                                          <li>
                                              <input type="radio" class="check" id="externa1" name="externa" value="1" data-radio="iradio_square-red"<?php if($data['externo']=='1'){echo ' checked';} ?>>
                                              <label for="externa1"><strong>SI</strong> &nbsp;</label>
                                          </li>
                                          <li>
                                              <input type="radio" class="check" id="externa2" name="externa" value="2" data-radio="iradio_square-red"<?php if($data['externo']=='2'){echo ' checked';} ?>>
                                  ...
                                  <div class="form-group<?php if(!empty($e10)){echo ' has-danger';} ?>">
                                      ...
                                      <input type="text" name="url_externa" class="form-control" id="input_externa" maxlength="250" value="<?php echo $data['url_externo']; ?>" placeholder="URL completa">
                                      <small class="form-control-feedback"><?php echo !empty($e10) ? $e10 : ''; ?></small>
                                  </div>                                                                    
                                
                                  <hr>
                                  <div class="text-center">
                                     <?php if(!empty($data['imagen1'])){ $_img1_ = $data['imagen1']; }else{ $_img1_ = 'no-disponible.jpg'; } ?>
                                     <img src="../images/productos/<?php echo $_img1_; ?>" class="img-fluid shadow" alt="IMAGEN PRODUCTO"/>
                                  </div>
                                  <hr>
                                  <br>

                                  <input type="hidden" name="action" value="send"/>
                                  <button type="submit" class="btn btn-info waves-effect waves-light m-r-10"><i class="fa fa-check"></i> Modificar producto</button>
...
?>
    ...
    <script type="text/javascript">
      ...
      $('#btnAllRight').click(function (e) {
         $('select').moveAllToListAndDelete('#list_genero1', '#list_categoria2');
         $('#list_categoria2 option').prop('selected', true);
         e.preventDefault();
      });
