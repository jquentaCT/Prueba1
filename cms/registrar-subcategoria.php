        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">REGISTRAR SUBCATEGORIA</h3>
                </div>
                            ...
                            <div class="card-body">
                                ...
                                if( !empty($action) ){
                                    ...
                                    if($encontro == '0'){  
                                         ...
                                         $p = $conectdata->set_grabar_subcategoria($variables);                                                                                 
                                         if($p==true){                                              
                                ...
                                <form class="form p-t-20" action="" method="post" enctype="multipart/form-data" autocomplete="off">
                                  ...
                                  <div class="form-group<?php if(!empty($e3)){echo ' has-danger';} ?>">
                                      <label for="select_cat">Categoría: <span class="text-danger">(*)</span></label>
                                      <div class="input-group">
                                          <select name="categoria" class="selectpicker m-b-20 m-r-10" id="select_cat" data-style="btn-danger">
                                              <option data-tokens="seleccionar" value="0">- Seleccionar la categoría -</option>
                                              <?php                                              
                                                $conectdata->set_listar('select idc, nombre from '.TABLE_PREFIX._TAB_CATP_SYS_.' order by nombre asc',$categoria); 
                                              ?>                                             
                                          </select>
                                      </div>
                                  ...
                                  <button type="submit" class="btn btn-info waves-effect waves-light m-r-10"><i class="fa fa-check"></i> Registrar subcategoría</button>
