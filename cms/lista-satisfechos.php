        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">LISTA DE CLIENTES SATISFECHOS</h3>
                </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <a href="./registrar-satifechos.php" class="btn btn-info" role="button" style="margin-bottom: 5px;">Registrar cliente satisfecho</a>
                        <?php include 'html/paginacion-satifechos.php'; ?>
                    </div>
                </div>
                <!-- Row -->
