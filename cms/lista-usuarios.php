        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">REGISTRAR USUARIOS</h3>
                </div>
                                ...
                                if( !empty($action) ){
                                    ...
                                    if($encontro == '0'){
                                         ...
                                         */
                                         ...
                                         $p = $conectdata->set_grabar_user($nombre,$apellido,$email,$login,$pwd1,$permisos,$new_file,$activar);
                                         if($p==true){
                                              ...
                                              Los nombres y apellidos o Login o Email ya se encuentran registrados, por favor verificar.
                                              </div>'; 
                                         }                                       
                                ...
                                <form class="form p-t-20" action="" method="post" enctype="multipart/form-data" autocomplete="off">
                                  ...
                                  <div class="form-group<?php if(!empty($e4)){echo ' has-danger';} ?>">
                                      ...
                                      <div class="input-group">
                                          ...
                                          <input type="email" name="email" class="form-control" id="input_email" maxlength="100" value="<?php echo $email; ?>" placeholder="Ingrese su email">
                                      </div>
                                  ...
                                  <div class="form-group<?php if(!empty($e8)){echo ' has-danger';} ?>">
                                      ...
                                      <div class="input-group">
                                          ...
                                          <input type="text" name="login" class="form-control" id="input_login" maxlength="40" value="<?php echo $login; ?>" placeholder="Login">
                                      </div>
