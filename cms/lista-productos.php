...
<body class="fix-header card-no-border">
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">LISTA DE PRODUCTOS</h3>
                </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <a href="./registrar-productos.php" class="btn waves-effect waves-light btn-rounded btn-sm btn-outline-info mb10 plr" role="button">REGISTRAR PRODUCTO &nbsp;<i class="icon-control-forward"></i></a>
                        <?php include 'html/paginacion-productos.php'; ?>
                    </div>
                </div>
                <!-- Row -->
    ...
    <script type="text/javascript">
    jQuery(document).ready(function() {
        $("input[name='episodios']").TouchSpin();                
    });
