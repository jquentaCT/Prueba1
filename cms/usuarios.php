...
$conectdata->set_item_page('select * from '.TABLE_PREFIX._TAB_USER_SYS_,15);
$pages = $conectdata->set_mostrar();
...
if( !empty($action) ){
    ...
    }else{ $e6 = '(*) Confirme la clave.'; $encontro = 1; }
...
<head>
    ...
    <title>OTAQUZ - PANEL ADMINISTRATIVO</title>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">USUARIOS INTERNOS</h3>
                </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-5">
                        <div class="card card-outline-info">
                            ...
                            <div class="card-header">
                              <h4 class="m-b-0 text-white">Usuario interno nuevo</h4>
                            </div>
                                ...
                                if( !empty($action) ){
                                    ...
                                    if($encontro == '0'){
                                         ...
                                         */
                                         ...
                                         $p = $conectdata->set_grabar_user($nombre,$apellido,$email,$pwd1,$permisos,$new_file,$activar);
                                         if($p==true){

                                              if(!empty($new_file)){
                                                   move_uploaded_file($tmp_name,'images/users/'.$new_file);
                                                   crear_miniaturas( "images/users/".$new_file, "200", "0", "images/users/tb_".$new_file);
                                                   list($w1, $h1, $type1, $attr1) = getimagesize('images/users/'.$new_file);
                                                   if( $w1 > 500 ){
                                                     crear_miniaturas( "images/users/".$new_file, "500", "0", "images/users/".$new_file);
                                                   }
                                              }
                                ...
                                <form class="form p-t-20" action="" method="post" enctype="multipart/form-data" autocomplete="off">
                                  ...
                                  <div class="form-group<?php if(!empty($e1)){echo ' has-danger';} ?>">
                                      ...
                                      <div class="input-group">
                                          ...
                                          <input type="text" name="nombre" class="form-control" id="input_nombre" maxlength="80" value="<? echo $nombre; ?>" placeholder="Nombre completo">                                          
                                      </div>
                                      <small class="form-control-feedback"><?php echo $e1; ?></small>
                                  </div>
                                  ...
                                  <div class="form-group<?php if(!empty($e2)){echo ' has-danger';} ?>">
                                      ...
                                      <div class="input-group">
                                          ...
                                          <input type="text" name="apellido" class="form-control" id="input_apellido" maxlength="80" value="<? echo $apellido; ?>" placeholder="Apellido completo">
                                      </div>
                                      <small class="form-control-feedback"><?php echo $e2; ?></small>
                                  </div>
                                  ...
                                  <div class="form-group<?php if(!empty($e3)){echo ' has-danger';} ?>">
                                      ...
                                      <div class="input-group">
                                          <select name="permisos" class="selectpicker m-b-20 m-r-10" id="select_perm" data-style="btn-danger">
                                              ...
                                              <?php                                              
                                                $conectdata->set_listar('select idpe, nombre from '.TABLE_PREFIX._TAB_PERM_SYS_.' order by nombre asc',$permisos); 
                                              ?>                                             
                                          </select>
                                      </div>
                                      <small class="form-control-feedback"><?php echo $e3; ?></small>
                                  </div>                                  
                                  ...
                                  <div class="form-group<?php if(!empty($e4)){echo ' has-danger';} ?>">
                                      ...
                                      <div class="input-group">
                                          ...
                                          <input type="email" name="email" class="form-control" id="input_email" maxlength="100" value="<? echo $email; ?>" placeholder="Ingrese su email">
                                      </div>
                                      <small class="form-control-feedback"><?php echo $e4; ?></small>
                                  </div>
                                  ...
                                  <div class="form-group<?php if(!empty($e5)){echo ' has-danger';} ?>">
                                      ...
                                      <div class="input-group">
                                          ...
                                          <input type="password" name="pwd1" class="form-control" id="pwd1" maxlength="60" value="<? echo $pwd1; ?>" placeholder="Ingrese su clave">
                                      </div>
                                      <small class="form-control-feedback"><?php echo $e5; ?></small>
                                  </div>
                                  ...
                                  <div class="form-group<?php if(!empty($e6)){echo ' has-danger';} ?>">
                                      ...
                                      <div class="input-group">
                                          ...
                                          <input type="password" name="pwd2" class="form-control" id="pwd2" maxlength="60" value="<? echo $pwd2; ?>" placeholder="Reingrese su clave">
                                      </div>
                                      <small class="form-control-feedback"><?php echo $e6; ?></small>
                                  </div>

                                  <label for="pwd2">Activar cuenta:</label>
                                  <div class="switchery-demo m-b-30">
                                      <input type="checkbox" name="activar" class="js-switch" value="Y" data-color="#ef5350"<?php if(!empty($activar) && $activar=='Y'){ echo ' checked'; } ?>/>
                                  </div>
                                  ...
                                  <div class="card form-group<?php if(!empty($e7)){echo ' has-danger';} ?>">
                                      ...
                                      <small class="form-control-feedback"><?php echo $e7; ?></small>
                                  </div>
                    ...
                    <div class="col-lg-7">
                        <?php include 'listado-usuarios.php'; ?>
                    </div>
                </div>
                <!-- Row -->
