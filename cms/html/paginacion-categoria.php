        ...
        <div class="table-responsive m-t-5">
            ...
            <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                ...
                ?>  
                  <tr>
                    <td>
                        <a href="./proceso-categoria.php?v=editar&cod=<?php echo $_id_; ?>" title="MODIFICAR"><i class="fa fa-edit"></i></a>
                        <a href="javascript:void(0)" class="btndelprocess" rel="<?php echo $_id_; ?>-categorias" title="ELIMINAR"><i class="fa fa-eraser text-danger"></i></a>
                        <?php echo $_nombre_; ?>
                    </td>
                    <td><?php echo $m; ?></td>                                
                  </tr>
