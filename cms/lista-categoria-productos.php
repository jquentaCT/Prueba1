        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">LISTA DE CATEGORIAS</h3>
                </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <a href="./registrar-categoria.php" class="btn btn-info" role="button" style="margin-bottom: 5px;">Registrar categoría</a>
                        <?php include 'html/paginacion-categoria.php'; ?>
                    </div>
                </div>
                <!-- Row -->
