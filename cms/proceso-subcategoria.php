...
if( !empty($action) ){
    ...
    if(empty($categoria) or $categoria=='0'){ $e3 = '(*) Seleccione la categoría'; $encontro = 1; }    
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">MODIFICAR SUBCATEGORIA</h3>
                </div>
...
<?php
  if($v=='borrar' && !empty($cod)){
     ...
     $info = $conectdata->get_data_subcategoria($cod);
     ...
     $conectdata->set_delete_subcategoria($cod);
     ...
     window.location.href = './registrar-subcategoria.php';
     </script>";
...
?>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <a href="./lista-subcategoria-productos.php" class="btn btn-info" role="button" style="margin-bottom: 5px;">Ver lista de subcategorías</a>                        
                            ...
                            <div class="card-body">
                                ...
                                if( !empty($action) ){
                                    ...
                                    if($encontro == '0'){
                                         ...
                                         $variables[0] = $nombre;
                                         $variables[1] = $url;
                                         $variables[2] = $categoria;                                         
                                         $variables[3] = $mostrar;

                                         $p = $conectdata->set_update_subcategoria($cod,$variables);
                                ...
                                $data = $conectdata->get_data_subcategoria($cod);     
                                ?>
                                ...
                                <form class="form p-t-20" action="./proceso-subcategoria.php?v=editar&cod=<?php echo $cod; ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                                  ...
                                  <div class="form-group<?php if(!empty($e2)){echo ' has-danger';} ?>">
                                      ...
                                      <div class="input-group">
                                          <div class="input-group-prepend">
                                              <span class="input-group-text" id="basic-addon1"><?php echo URL_SITE; ?>/subcategoria/</span>
                                          </div>
                                  ...
                                  <div class="form-group<?php if(!empty($e3)){echo ' has-danger';} ?>">
                                      <label for="select_marca">Categoría: <span class="text-danger">(*)</span></label>
                                      <div class="input-group">
                                          <select name="select_cat" class="selectpicker m-b-20 m-r-10" id="select_cat" data-style="btn-danger">
                                              <option data-tokens="seleccionar" value="0">- Seleccionar la categoría -</option>
                                              <?php                                              
                                                $conectdata->set_listar('select idc, nombre from '.TABLE_PREFIX._TAB_CATP_SYS_.' order by nombre asc',$data['categoria']); 
                                              ?>                                             
                                          </select>
                                      </div>
