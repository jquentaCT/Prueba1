...
<html lang="en">
  <head>
    ...
    <title>Equipos Médicos / Medidores y Probadores de Parametros / PSS</title>    
  ...
  <div class="slider bg-navy-blue bg-scroll pos-rel breadcrumbs-page">
    <div class="container">      
      <div class="breadcrumbs-description">
        <h1>Productos</h1>
        EQUIPOS MÉDICOS: MEDIDORES Y PROBADORES DE PARAMETROS
      </div>
    </div>
  </div>
          ...
          <div class="col-md-12 ml-auto why-choose wow fadeInRight" data-wow-duration="0" data-wow-delay="0.6s">
              ...
              <section class="bg-white wide-tb-50 bg-wave">
                <div class="container">
                      ...
                      <h3 class="h3-sm fw-6 txt-blue mb-4">PRODUCTOS / EQUIPOS MÉDICOS / MEDIDORES Y PROBADORES DE PARAMETROS</h3>  
                      
                      <div class="row">
                          <div class="col-lg-4">  
                              <div class="boxmarcas">
                                 <a href="https://www.labotronics.com/Meters-and-Testers" target="_blank"><img src="images/labotronics.png" alt=""/></a>
                                 <a href="https://www.labotronics.com/Meters-and-Testers" target="_blank" class="btn">Labotronics</a>
                              </div> 
                          </div>
                      ...
                      <div class="row">
                          <div class="col-lg-4">
                               <ul class="list-unstyled icons-listing mb-0">                                    
                                    <li><i class="icofont-check"></i> Medidor de Monóxido de Carbono</li>
                                    <li><i class="icofont-check"></i> Termómetro de contacto</li>
                                    <li><i class="icofont-check"></i> Termo Hidrómetro Digital</li>
                                    <li><i class="icofont-check"></i> Analizadores Ambientales</li>
                                    <li><i class="icofont-check"></i> Termómetros IR</li>                                                                             
                               </ul>
                          </div>
                          <div class="col-lg-4">
                               <ul class="list-unstyled icons-listing mb-0">                                    
                                    <li><i class="icofont-check"></i> Medidores laser a distancia</li>
                                    <li><i class="icofont-check"></i> Medidores Ambientales de bolsillo</li>
                                    <li><i class="icofont-check"></i> Medidores de Humedad</li>
                                    <li><i class="icofont-check"></i> Analizadores de Humedad</li>                                                                           
                               </ul>
                          </div>
                          <div class="col-lg-4"></div>     
                      </div>
                      ...
                      <div class="row">
                          <div class="col-lg-4 text-center">
                               <img src="images/equipos-medicos/producto-image057.png" alt="">
                          </div>
                          <div class="col-lg-8">
                               <p>&nbsp;</p>                             
                               <p>Medidor de entorno multifunción LB-10MEM es una unidad multifuncional digital 5 en 1. Mide la temperatura, % HR, nivel de sonido, nivel de luz y velocidad del aire. La pantalla grande y clara con retroiluminación garantiza una legibilidad óptima, incluso en un entorno oscuro. Incluye sensores semiconductores para medir la humedad y la temperatura ambiente. La unidad se apaga automáticamente después de 15 minutos de inactividad, lo que prolonga la vida útil de la batería.</p>
                          </div>     
                      </div>                          
