...
<html lang="en">
  <head>
    ...
    <title>Equipos Médicos / Consumibles y Suministros para Laboratorios / PSS</title>    
  ...
  <div class="slider bg-navy-blue bg-scroll pos-rel breadcrumbs-page">
    <div class="container">      
      <div class="breadcrumbs-description">
        <h1>Productos</h1>
        EQUIPOS MÉDICOS: CONSUMIBLES Y SUMINISTROS PARA LABORATORIOS
      </div>
    </div>
  </div>
          ...
          <div class="col-md-12 ml-auto why-choose wow fadeInRight" data-wow-duration="0" data-wow-delay="0.6s">
              ...
              <section class="bg-white wide-tb-50 bg-wave">
                <div class="container">
                      ...
                      <h3 class="h3-sm fw-6 txt-blue mb-4">PRODUCTOS / EQUIPOS MÉDICOS / CONSUMIBLES Y SUMINISTROS PARA LABORATORIOS</h3>  
                      
                      <div class="row">
                          <div class="col-lg-4">  
                              <div class="boxmarcas">
                                 <a href="https://www.labotronics.com/Laboratory-Consumables-and-Supplies" target="_blank"><img src="images/labotronics.png" alt=""/></a>
                                 <a href="https://www.labotronics.com/Laboratory-Consumables-and-Supplies" target="_blank" class="btn">Labotronics</a>
                              </div> 
                          </div>
                      ...
                      <div class="row">
                          <div class="col-lg-4">
                               <ul class="list-unstyled icons-listing mb-0">                                    
                                    <li><i class="icofont-check"></i> Mechero</li>
                                    <li><i class="icofont-check"></i> Desecador</li>
                                    <li><i class="icofont-check"></i> Sistema de Filtración</li>
                                    <li><i class="icofont-check"></i> Esterilizador de Frascos</li>
                                    <li><i class="icofont-check"></i> Lavador de Tubos con Aire</li>                               
                              </ul>
                          </div>
                          <div class="col-lg-4">
                              <ul class="list-unstyled icons-listing mb-0">                                    
                                    <li><i class="icofont-check"></i> Mesa de elevación para frascos</li>
                                    <li><i class="icofont-check"></i> Contenedor de Nitrógeno Liquido</li>
                                    <li><i class="icofont-check"></i> Stand con Base</li>
                                    <li><i class="icofont-check"></i> Trípode </li>
                              </ul>
                          </div>
                          <div class="col-lg-4"></div>     
                      </div>                     
                      ...
                      <div class="row">
                          <div class="col-lg-4 text-center">
                               <img src="images/equipos-medicos/producto-image048.png" alt="">
                          </div>
                          <div class="col-lg-8">
                               <p>&nbsp;</p>
                               <p>El secador de aire con tubo de vidrio LB-10 GRADE es una unidad controlada por microprocesador con ventilador interno. Se caracteriza por un completo control electrónico de temperatura para el secado de tubos orientado al calor.</p>
                          </div>     
                      </div>                          
