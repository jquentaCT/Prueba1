...
<html lang="en">
  <head>
    ...
    <title>Equipos Médicos / Balanzas / PSS</title>    
          ...
          <div class="col-md-12 ml-auto why-choose wow fadeInRight" data-wow-duration="0" data-wow-delay="0.6s">
              ...
              <section class="bg-white wide-tb-50 bg-wave">
                <div class="container">
                      ...
                      <h3 class="h3-sm fw-6 txt-blue mb-4">PRODUCTOS / EQUIPOS MÉDICOS / BALANZAS</h3>  
                      
                      <div class="row">
                          <div class="col-lg-4">  
                              <div class="boxmarcas">
                                 <a href="https://www.labotronics.com/Weighing-Equipment" target="_blank"><img src="images/labotronics.png" alt=""/></a>
                                 <a href="https://www.labotronics.com/Weighing-Equipment" target="_blank" class="btn">Labotronics</a>
                              </div> 
                          </div>
                          <div class="col-lg-4">
                              <div class="boxmarcas">
                                 <a href="https://www.humboldtmfg.com/scales.html" target="_blank"><img src="images/humboldt.png" alt=""/></a>
                                 <a href="https://www.humboldtmfg.com/scales.html" target="_blank" class="btn">Humboldt</a>
                              </div>
                          </div>
                      ...
                      <div class="row">
                          <div class="col-lg-4 text-center">
                               <img src="images/equipos-medicos/producto-image063.png" alt="">
                          </div>
                          <div class="col-lg-8">
                               <p>&nbsp;</p>
                               <p>La balanza analítica del sensor LB-10AWM es una balanza analítica de alta velocidad equipada con una capacidad de pesaje máxima de 60 g. Construido con un sensor magnético inalámbrico superior para un pesaje preciso y estabilidad. El panel cuenta con una pantalla LCD para el monitoreo visual del peso medido y los botones operativos para una operación manual fácil. Cuenta con un parabrisas deslizante de vidrio para una mejor accesibilidad visual.</p>
                          </div>     
                      </div>                          
