...
<html lang="en">
  <head>
    ...
    <title>Equipos Médicos / Instrumentos Analizadores de Agua / PSS</title>    
  ...
  <div class="slider bg-navy-blue bg-scroll pos-rel breadcrumbs-page">
    <div class="container">      
      <div class="breadcrumbs-description">
        <h1>Productos</h1>
        EQUIPOS MÉDICOS: INSTRUMENTOS ANALIZADORES DE AGUA
      </div>
    </div>
  </div>
          ...
          <div class="col-md-12 ml-auto why-choose wow fadeInRight" data-wow-duration="0" data-wow-delay="0.6s">
              ...
              <section class="bg-white wide-tb-50 bg-wave">
                <div class="container">
                      ...
                      <h3 class="h3-sm fw-6 txt-blue mb-4">PRODUCTOS / EQUIPOS MÉDICOS / INSTRUMENTOS ANALIZADORES DE AGUA</h3>  
                      
                      <div class="row">
                          <div class="col-lg-4">  
                              <div class="boxmarcas">
                                 <a href="https://www.labotronics.com/Water-Testing-Instrument" target="_blank"><img src="images/labotronics.png" alt=""/></a>
                                 <a href="https://www.labotronics.com/Water-Testing-Instrument" target="_blank" class="btn">Labotronics</a>
                              </div> 
                          </div>
                      ...
                      <div class="row">
                          <div class="col-lg-4">
                               <ul class="list-unstyled icons-listing mb-0">                                    
                                    <li><i class="icofont-check"></i> Banco de Pruebas de Conductividad</li>
                                    <li><i class="icofont-check"></i> Banco de Pruebas de Turbiedad</li>
                                    <li><i class="icofont-check"></i> Medidor de Clorinidad</li>
                                    <li><i class="icofont-check"></i> EsTermo Reactor COD</li>                                           
                               </ul>
                          </div>
                          <div class="col-lg-4">
                               <ul class="list-unstyled icons-listing mb-0">                                    
                                    <li><i class="icofont-check"></i> Probador de Salinidad portátil</li>
                                    <li><i class="icofont-check"></i> Medidor de bolsillo ORP</li>
                                    <li><i class="icofont-check"></i> PH Metro</li>
                                    <li><i class="icofont-check"></i> PH Metro de Bolsillo</li>                                       
                               </ul>
                          </div>
                          <div class="col-lg-4">
                               <ul class="list-unstyled icons-listing mb-0">                                    
                                    <li><i class="icofont-check"></i> Probador de TDS de Bolsillo</li>
                                    <li><i class="icofont-check"></i> Probador de Turbidez Portátil</li>
                                    <li><i class="icofont-check"></i> Turbidimetro</li>
                               </ul>
                          </div>     
                      </div>
                      ...
                      <div class="row">
                          <div class="col-lg-4 text-center">
                               <img src="images/equipos-medicos/producto-image058.png" alt="">
                          </div>
                          <div class="col-lg-8">
                               <p>&nbsp;</p>                             
                               <p>El turbidímetro de relación LB-10RTM es una unidad de banco de alta precisión con una lámpara halógena de tungsteno como fuente de luz. Amplia gama de opciones de calibración con fotocélula de silicio como elemento receptor. Decaimiento de partículas insolubles suspendidas en agua o líquidos transparentes.</p>
                          </div>     
                      </div>                          
