...
<html lang="en">
  <head>
    ...
    <title>Equipos Médicos / Lavadores y Desinfectadores de Laboratorio / PSS</title>    
  ...
  <div class="slider bg-navy-blue bg-scroll pos-rel breadcrumbs-page">
    <div class="container">      
      <div class="breadcrumbs-description">
        <h1>Productos</h1>
        EQUIPOS MÉDICOS: LAVADORES Y DESINFECTADORES DE LABORATORIO
      </div>
    </div>
  </div>
          ...
          <div class="col-md-12 ml-auto why-choose wow fadeInRight" data-wow-duration="0" data-wow-delay="0.6s">
              ...
              <section class="bg-white wide-tb-50 bg-wave">
                <div class="container">
                      ...
                      <h3 class="h3-sm fw-6 txt-blue mb-4">PRODUCTOS / EQUIPOS MÉDICOS / LAVADORES Y DESINFECTADORES DE LABORATORIO</h3>  
                      
                      <div class="row">
                          <div class="col-lg-4">  
                              <div class="boxmarcas">
                                 <a href="https://www.labotronics.com/Laboratory-Washers-And-Disinfector" target="_blank"><img src="images/labotronics.png" alt=""/></a>
                                 <a href="https://www.labotronics.com/Laboratory-Washers-And-Disinfector" target="_blank" class="btn">Labotronics</a>
                              </div> 
                          </div>
                      ...
                      <div class="row">
                          <div class="col-lg-4">
                               <ul class="list-unstyled icons-listing mb-0">                                    
                                    <li><i class="icofont-check"></i> Maquina Lavador de Cristales</li>
                                    <li><i class="icofont-check"></i> Lavador Ultarsónico</li>                                                                             
                               </ul>
                          </div>
                          <div class="col-lg-4"></div>
                          <div class="col-lg-4"></div>     
                      ...
                      <div class="row">
                          <div class="col-lg-4 text-center">
                               <img src="images/equipos-medicos/producto-image052.png" alt="">
                          </div>
                          <div class="col-lg-8">
                               <p>&nbsp;</p>                             
                               <p>La lavadora de cristalería LB-10GWM es una unidad de limpieza de cristalería de laboratorio controlada por CPU SCM totalmente automatizada. Se caracteriza por un excelente lavado y desinfección térmica antibacteriana con función de granallado. Los sistemas de tuberías incorporados con válvulas y bombas efectivas permiten una eficiente limpieza por pulverización y esterilización por calor.</p>
                          </div>     
                      </div>                          
