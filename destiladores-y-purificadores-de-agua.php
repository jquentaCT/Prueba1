...
<html lang="en">
  <head>
    ...
    <title>Equipos Médicos / Destiladores y Purificadores de Agua / PSS</title>    
  ...
  <div class="slider bg-navy-blue bg-scroll pos-rel breadcrumbs-page">
    <div class="container">      
      <div class="breadcrumbs-description">
        <h1>Productos</h1>
        EQUIPOS MÉDICOS: DESTILADORES Y PURIFICADORES DE AGUA
      </div>
    </div>
  </div>
          ...
          <div class="col-md-12 ml-auto why-choose wow fadeInRight" data-wow-duration="0" data-wow-delay="0.6s">
              ...
              <section class="bg-white wide-tb-50 bg-wave">
                <div class="container">
                      ...
                      <h3 class="h3-sm fw-6 txt-blue mb-4">PRODUCTOS / EQUIPOS MÉDICOS / DESTILADORES Y PURIFICADORES DE AGUA</h3>  
                      
                      <div class="row">
                          <div class="col-lg-4">  
                              <div class="boxmarcas">
                                 <a href="https://www.labotronics.com/Water-Distillation-And-Purification-System" target="_blank"><img src="images/labotronics.png" alt=""/></a>
                                 <a href="https://www.labotronics.com/Water-Distillation-And-Purification-System" target="_blank" class="btn">Labotronics</a>
                              </div> 
                          </div>
                      ...
                      <div class="row">
                          <div class="col-lg-4">
                               <ul class="list-unstyled icons-listing mb-0">                                    
                                    <li><i class="icofont-check"></i> Kit de destilación rápida</li>
                                    <li><i class="icofont-check"></i> Destiladores de Agua</li>
                                    <li><i class="icofont-check"></i> Purificador de agua</li>
                                    <li><i class="icofont-check"></i> Destiladores Atmosfericos</li>
                              </ul>
                          </div>
                          <div class="col-lg-4">
                              <ul class="list-unstyled icons-listing mb-0">
                                    <li><i class="icofont-check"></i> Destiladores al Vacío</li>                                   
                                    <li><i class="icofont-check"></i> Nano Purificadores</li>
                                    <li><i class="icofont-check"></i> Ultar Purificadores</li>
                              </ul>
                          </div>
                          <div class="col-lg-4"></div>     
                      </div>          
                      ...
                      <div class="row">
                          <div class="col-lg-4 text-center">
                               <img src="images/equipos-medicos/producto-image054.png" alt="">
                          </div>
                          <div class="col-lg-8">
                               <p>&nbsp;</p>                             
                               <p>El kit de destilación de trayectoria corta LB-21SDK es un kit de destilación de 5 litros que incluye un manto calefactor de agitación magnética, un kit de cristalería, una trampa fría y un enfriador para el enfriamiento preciso del condensador. Cuenta con un manto calefactor con la funcionalidad de agitación magnética para una mejor homogeneización de la solución. La característica de trampa fría protege la bomba de vacío de la contaminación y el daño de los vapores.</p>
                          </div>     
                      </div>                          
