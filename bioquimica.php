...
<html lang="en">
  <head>
    ...
    <title>Equipos Médicos / Bioquímica / PSS</title>    
          ...
          <div class="col-md-12 ml-auto why-choose wow fadeInRight" data-wow-duration="0" data-wow-delay="0.6s">
              ...
              <section class="bg-white wide-tb-50 bg-wave">
                <div class="container">
                      ...
                      <h3 class="h3-sm fw-6 txt-blue mb-4">PRODUCTOS / EQUIPOS MÉDICOS / BIOQUÍMICA</h3>  
                      
                      <div class="row">
                          <div class="col-lg-4">  
                              <div class="boxmarcas">
                                 <a href="https://www.labotronics.com/Biochemistry" target="_blank"><img src="images/labotronics.png" alt=""/></a>
                                 <a href="https://www.labotronics.com/Biochemistry" target="_blank" class="btn">Labotronics</a>
                              </div> 
                          </div>
                      ...
                      <div class="row">
                          <div class="col-lg-4">
                               <ul class="list-unstyled icons-listing mb-0">                                    
                                    <li><i class="icofont-check"></i> Analizador Bioquímico Automático</li>
                                    <li><i class="icofont-check"></i> Colorímetro</li>
                                    <li><i class="icofont-check"></i> Analizador de Electrolitos</li>
                                    <li><i class="icofont-check"></i> Clitómetro de Flujo</li>
                                    <li><i class="icofont-check"></i> Analizador Completo de químicos</li>
                              </ul>
                          </div>
                          <div class="col-lg-4">
                              <ul class="list-unstyled icons-listing mb-0">                                    
                                    <li><i class="icofont-check"></i> Analizador Hematológico</li>
                                    <li><i class="icofont-check"></i> Analizador Multi Pruebas</li>
                                    <li><i class="icofont-check"></i> Analizador de Pura fibra</li>
                                    <li><i class="icofont-check"></i> Analizador Químico Semi Automático</li>
                              </ul>
                          </div>
                          <div class="col-lg-4"></div>     
                      </div>
                      ...
                      <div class="row">
                          <div class="col-lg-4 text-center">
                               <img src="images/equipos-medicos/producto-image050.png" alt="">
                          </div>
                          <div class="col-lg-8">
                               <p>&nbsp;</p>
                               <p>El analizador automático de bioquímica LB-10ABA es una unidad con tecnología de prueba avanzada y altamente sensible. Cuenta con diluyente de alta precisión, tecnología avanzada de sellado y conexión para proporcionar un muestreo preciso. Dos cámaras de reactivos separadas con refrigeradores independientes. La sonda Nano tratada interna y externa reduce efectivamente los residuos de la sonda y la transferencia.</p>
                          </div>     
                      </div>                          
