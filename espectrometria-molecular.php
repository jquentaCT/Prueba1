...
<html lang="en">
  <head>
    ...
    <title>Equipos Médicos / Espectrometria Molecular / PSS</title>    
  ...
  <div class="slider bg-navy-blue bg-scroll pos-rel breadcrumbs-page">
    <div class="container">      
      <div class="breadcrumbs-description">
        <h1>Productos</h1>
        EQUIPOS MÉDICOS: ESPECTROMETRIA MOLECULAR
      </div>
    </div>
  </div>
          ...
          <div class="col-md-12 ml-auto why-choose wow fadeInRight" data-wow-duration="0" data-wow-delay="0.6s">
              ...
              <section class="bg-white wide-tb-50 bg-wave">
                <div class="container">
                      ...
                      <h3 class="h3-sm fw-6 txt-blue mb-4">PRODUCTOS / EQUIPOS MÉDICOS / ESPECTROMETRIA MOLECULAR</h3>  
                      
                      <div class="row">
                          <div class="col-lg-4">  
                              <div class="boxmarcas">
                                 <a href="https://www.labotronics.com/Molecular-Spectroscopy" target="_blank"><img src="images/labotronics.png" alt=""/></a>
                                 <a href="https://www.labotronics.com/Molecular-Spectroscopy" target="_blank" class="btn">Labotronics</a>
                              </div> 
                          </div>
                      ...
                      <div class="row">
                          <div class="col-lg-4">
                               <ul class="list-unstyled icons-listing mb-0">                                    
                                    <li><i class="icofont-check"></i> Espectro meter</li>
                                    <li><i class="icofont-check"></i> Espectro fotómetro</li>        
                              </ul>
                          </div>
                          <div class="col-lg-4"></div>
                          <div class="col-lg-4"></div>     
                      ...
                      <div class="row">
                          <div class="col-lg-4 text-center">
                               <img src="images/equipos-medicos/producto-image053.png" alt="">
                          </div>
                          <div class="col-lg-8">
                               <p>&nbsp;</p>                             
                               <p>El espectrómetro de fotomultiplicadores LB-10PS es un analizador de metales altamente integrado con un rango de banda de longitud de onda de 120 nm a 800 nm. La tecnología DDD de fuente de luz compuesta de cobertura inteligente totalmente digital, admite el dispositivo mediante el ajuste automático de los parámetros de excitación de la fuente de luz de acuerdo con diferentes características de excitación de una determinada fuente.</p>
                          </div>     
                      </div>                          
