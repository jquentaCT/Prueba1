...
<html lang="en">
  <head>
    ...
    <title>Equipos de Ingenieria / Celdas de Calibración / PSS</title>    
  ...
  <div class="slider bg-navy-blue bg-scroll pos-rel breadcrumbs-page">
    <div class="container">      
      <div class="breadcrumbs-description">
        <h1>Productos</h1>
        EQUIPOS DE INGENIERIA: CELDAS DE CALIBRACIÓN
      </div>
    </div>
  </div>
          ...
          <div class="col-md-12 ml-auto why-choose wow fadeInRight" data-wow-duration="0" data-wow-delay="0.6s">
              ...
              <section class="bg-white wide-tb-50 bg-wave">
                <div class="container">
                      ...
                      <h3 class="h3-sm fw-6 txt-blue mb-4">PRODUCTOS / EQUIPOS DE INGENIERIA / CELDAS DE CALIBRACIÓN</h3>  
                      
                      <div class="row">
                          <div class="col-lg-4">  
                              <div class="boxmarcas">
                                 <a href="https://www.humboldtmfg.com/?act=search&query=LOAD+CELL" target="_blank"><img src="images/humboldt.png" alt=""/></a>
                                 <a href="https://www.humboldtmfg.com/?act=search&query=LOAD+CELL" target="_blank" class="btn">Humboldt</a>
                              </div> 
                          </div>
                          <div class="col-lg-4">    
                              <div class="boxmarcas">
                                 <a href="https://www.gdsinstruments.com/gds-products/type/transducers-and-load-cells" target="_blank"><img src="images/gds.png" alt=""/></a>
                                 <a href="https://www.gdsinstruments.com/gds-products/type/transducers-and-load-cells" target="_blank" class="btn">GDS</a>
                              </div>
                          </div>
                          <div class="col-lg-4">  
                              <div class="boxmarcas">
                                 <a href="http://www.testingequipmentie.com/Load_Cell_Calibration_System.html" target="_blank"><img src="images/testingequipmentie.png" alt=""/></a>
                                 <a href="http://www.testingequipmentie.com/Load_Cell_Calibration_System.html" target="_blank" class="btn">Testingequipmentie</a>                              
                              </div> 
                          </div>
                      </div>  
                      ...
                      <div class="row">
                          <div class="col-lg-4 text-center">
                               <img src="images/equipos-ingenieria/producto-image030.png" alt="">
                          </div>
                          <div class="col-lg-8">
                               <p>El Calibrador axial /Torsonal de Epsilon tiene una resolución de 60 micropulgadas (0.001 mm) y tiene 2 pulgadas (50mm) de rango de medición de rotación axial y torsión de 0.050 pulgadas (1.27 mm) de movimiento lineal equivalente a 1 ° de giro, pantalla digital</p>
                          </div>     
                      </div>
                      <br>
                      ...
                      <div class="row">
                          <div class="col-lg-4 text-center">
                               <img src="images/equipos-ingenieria/producto-image033.png" alt="">
                          </div>
                          <div class="col-lg-8">
                              <p>Especificaciones principales:</p>
                              <ol>
                                  <li>Pantalla: pantalla de seis dígitos.</li>
                                  <li>Rango de sensibilidad de la celda de carga: 1mv / v, 1.5 mv / v, 2mv / v y 3mv / v</li>
                                  <li>Precisión de medición: 0.005% FS</li>
                                  <li>Número interno de división: 1/650000</li>
                                  <li>Fuente de alimentación: 220VAC ± 10%, 50 Hz.</li>
                                  <li>Tensión emocionante: 5V (DC)</li>
                                  <li>Método de calibración: bloqueo del teclado</li>
                                  <li>Canal múltiple inteligente: se puede operar con seis celdas de carga.</li>
                                  <li>Los parámetros del sistema se pueden almacenar dentro de EEPROM que tiene una interfaz externa.</li>
                                  <li>Forma de celda de carga: Max. Carga: 3000kN con celda de carga e indicador digital.</li>
                              </ol>  
                          </div>     
                      </div>                         
