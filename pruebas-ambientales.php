...
<html lang="en">
  <head>
    ...
    <title>Equipos Médicos / Pruebas Ambientales / PSS</title>    
  ...
  <div class="slider bg-navy-blue bg-scroll pos-rel breadcrumbs-page">
    <div class="container">      
      <div class="breadcrumbs-description">
        <h1>Productos</h1>
        EQUIPOS MÉDICOS: PRUEBAS AMBIENTALES
      </div>
    </div>
  </div>
        ...
        <div class="row">
          ...
          <div class="col-md-12 ml-auto why-choose wow fadeInRight" data-wow-duration="0" data-wow-delay="0.6s">
              ...
              <section class="bg-white wide-tb-50 bg-wave">
                <div class="container">                                       
                      <h3 class="h3-sm fw-6 txt-blue mb-4">PRODUCTOS / EQUIPOS MÉDICOS / PRUEBAS AMBIENTALES</h3>  
                      
                      <div class="row">
                          <div class="col-lg-4">  
                              <div class="boxmarcas">
                                 <a href="https://www.labotronics.com/Environmental-Testing" target="_blank"><img src="images/labotronics.png" alt=""/></a>
                                 <a href="https://www.labotronics.com/Environmental-Testing" target="_blank" class="btn">Labotronics</a>
                              </div> 
                          </div>
                      ...
                      <div class="row">
                          <div class="col-lg-4">
                               <ul class="list-unstyled icons-listing mb-0">                                    
                                    <li><i class="icofont-check"></i> Analizador de Aire</li>
                                    <li><i class="icofont-check"></i> Analizadores de Mezcla</li>
                                    <li><i class="icofont-check"></i> Analizadores de Azufre</li>
                                    <li><i class="icofont-check"></i> Fijadores de Gases</li>
                                    <li><i class="icofont-check"></i> Fijadores de gases Infrarrojos</li>
                                    <li><i class="icofont-check"></i> Detectores de Gases</li>
                                    <li><i class="icofont-check"></i> Analizadores Halógenos de Humedad</li>                                                                                                                
                               </ul>
                          </div>
                          <div class="col-lg-4">
                              <ul class="list-unstyled icons-listing mb-0">                                    
                                    <li><i class="icofont-check"></i> Analizadores Multi- de Gases</li>
                                    <li><i class="icofont-check"></i> Evaporador de Nitrógeno</li>
                                    <li><i class="icofont-check"></i> Analizadores de Nitrógeno y Oxigeno</li>
                                    <li><i class="icofont-check"></i> Analizadores de Minerales</li>
                                    <li><i class="icofont-check"></i> Bomba Peristáltica</li>
                                    <li><i class="icofont-check"></i> Analizadores de metales preciosos</li>
                                    <li><i class="icofont-check"></i> Analizadores de RoHS</li>                                                                                                                
                               </ul>
                          </div>
                          <div class="col-lg-4">
                               <ul class="list-unstyled icons-listing mb-0">                                    
                                    <li><i class="icofont-check"></i> Cabinas de Seguridad de contaminantes</li>
                                    <li><i class="icofont-check"></i> Analizador portátil de Gases</li>
                                    <li><i class="icofont-check"></i> Analizador de Metales Solidos</li>
                                    <li><i class="icofont-check"></i> Cámara de Pruebas</li>
                                    <li><i class="icofont-check"></i> Analizador de Gases de pared</li>                                                                                                               
                               </ul>
                          </div>     
                      </div>
                      ...
                      <div class="row">
                          <div class="col-lg-4 text-center">
                               <img src="images/equipos-medicos/producto-image046.png" alt="">
                          </div>
                          <div class="col-lg-8">
                               <p>&nbsp;</p>                             
                               <p>El analizador de gas infrarrojo fijo LB-35FIA es un analizador de modelo fijo diseñado para monitorear, detectar y analizar gases combustibles, tóxicos y venenosos presentes en áreas con condiciones ambientales severas. Compuesto de aleación de aluminio y acero inoxidable que lo hace resistente a la corrosión. Equipado con panel de control para monitoreo remoto controlado de un área de análisis grande. El sistema incorporado de relé de alarma y falla facilita la protección del personal y la planta contra riesgos inflamables, tóxicos y de oxígeno.</p>
                          </div>     
                      </div>                          
