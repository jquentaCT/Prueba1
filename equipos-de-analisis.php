...
<html lang="en">
  <head>
    ...
    <title>Equipos Médicos / Equipos de Analisis / PSS</title>    
  ...
  <div class="slider bg-navy-blue bg-scroll pos-rel breadcrumbs-page">
    <div class="container">      
      <div class="breadcrumbs-description">
        <h1>Productos</h1>
        EQUIPOS MÉDICOS: EQUIPOS DE ANALISIS
      </div>
    </div>
  </div>
          ...
          <div class="col-md-12 ml-auto why-choose wow fadeInRight" data-wow-duration="0" data-wow-delay="0.6s">
              ...
              <section class="bg-white wide-tb-50 bg-wave">
                <div class="container">
                      ...
                      <h3 class="h3-sm fw-6 txt-blue mb-4">PRODUCTOS / EQUIPOS MÉDICOS / EQUIPOS DE ANALISIS</h3>  
                      
                      <div class="row">
                          <div class="col-lg-4">  
                              <div class="boxmarcas">
                                 <a href="https://www.labotronics.com/Analytical-Equipment" target="_blank"><img src="images/labotronics.png" alt=""/></a>
                                 <a href="https://www.labotronics.com/Analytical-Equipment" target="_blank" class="btn">Labotronics</a>
                              </div> 
                          </div>
                      ...
                      <div class="row">
                          <div class="col-lg-4">
                               <ul class="list-unstyled icons-listing mb-0">                                    
                                    <li><i class="icofont-check"></i> Sistema automatizado de extracción en fase sólida</li>
                                    <li><i class="icofont-check"></i> Cromatografía de Gases</li>
                                    <li><i class="icofont-check"></i> GC-MS</li>
                                    <li><i class="icofont-check"></i> HPLC</li>
                                    <li><i class="icofont-check"></i> Hidrómetros</li>
                                    <li><i class="icofont-check"></i> Cromatografía de Ion</li>                               
                              </ul>
                          </div>
                          <div class="col-lg-4">
                              <ul class="list-unstyled icons-listing mb-0">
                                    <li><i class="icofont-check"></i> Sistema Kjendahl</li>
                                    <li><i class="icofont-check"></i> LC-MS</li>
                                    <li><i class="icofont-check"></i> Cromatografía de Líquidos</li>
                                    <li><i class="icofont-check"></i> Contador de Partículas</li>
                                    <li><i class="icofont-check"></i> Analizador de Tamaño de Partículas</li>                                   
                                    <li><i class="icofont-check"></i> Polarímetro</li>
                              </ul>
                          </div>
                          <div class="col-lg-4">
                              <ul class="list-unstyled icons-listing mb-0">
                                    <li><i class="icofont-check"></i> Refractómetro</li>
                                    <li><i class="icofont-check"></i> Extractor de partículas Solidas</li>
                                    <li><i class="icofont-check"></i> Analizador TOC</li>
                                    <li><i class="icofont-check"></i> Viscosímetro</li>
                              </ul>
                          </div>     
                      </div>
                      ...
                      <div class="row">
                          <div class="col-lg-4 text-center">
                               <img src="images/equipos-medicos/producto-image044.png" alt="">
                          </div>
                          <div class="col-lg-8">
                               <p>&nbsp;</p>                             
                               <p>La cromatografía de gases LB-50GC está equipada con un programa de temperatura de plataforma de 9 fases 10 con un rango de temperatura de 5 ° C a 400 ° C. Cuenta con un detector de ionización de llama (FID) controlado por APC con alta sensibilidad para una variedad de análisis. La provisión incorporada para la función de disparo externo síncrono y el disparo externo inician el equipo y el software de la estación de trabajo al mismo tiempo.</p>
                          </div>     
                      </div>                          
