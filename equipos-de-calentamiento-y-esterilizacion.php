...
<html lang="en">
  <head>
    ...
    <title>Equipos Médicos / Equipos de Calentamiento y Esterilización / PSS</title>    
  ...
  <div class="slider bg-navy-blue bg-scroll pos-rel breadcrumbs-page">
    <div class="container">      
      <div class="breadcrumbs-description">
        <h1>Productos</h1>
        EQUIPOS MÉDICOS: EQUIPOS DE CALENTAMIENTO Y ESTERILIZACIÓN
      </div>
    </div>
  </div>
          ...
          <div class="col-md-12 ml-auto why-choose wow fadeInRight" data-wow-duration="0" data-wow-delay="0.6s">
              ...
              <section class="bg-white wide-tb-50 bg-wave">
                <div class="container">
                      ...
                      <h3 class="h3-sm fw-6 txt-blue mb-4">PRODUCTOS / EQUIPOS MÉDICOS / EQUIPOS DE CALENTAMIENTO Y ESTERILIZACIÓN</h3>  
                      
                      <div class="row">
                          <div class="col-lg-4">  
                              <div class="boxmarcas">
                                 <a href="https://www.labotronics.com/Heating-Equipment" target="_blank"><img src="images/labotronics.png" alt=""/></a>
                                 <a href="https://www.labotronics.com/Heating-Equipment" target="_blank" class="btn">Labotronics</a>
                              </div> 
                          </div>
                      ...
                      <div class="row">
                          <div class="col-lg-4">
                               <ul class="list-unstyled icons-listing mb-0">                                    
                                    <li><i class="icofont-check"></i> Autoclaves de Frontera</li>
                                    <li><i class="icofont-check"></i> Baño Maria recirculante</li>
                                    <li><i class="icofont-check"></i> Aparato de Digestión</li>
                                    <li><i class="icofont-check"></i> Hornos</li>
                                    <li><i class="icofont-check"></i> Manta de Calentamiento</li>                                                                
                              </ul>
                          </div>
                          <div class="col-lg-4">
                              <ul class="list-unstyled icons-listing mb-0">
                                    <li><i class="icofont-check"></i> Plato de Calentamiento</li>
                                    <li><i class="icofont-check"></i> Plato de Calentamiento con agitador magnético</li>
                                    <li><i class="icofont-check"></i> Incubadoras</li>
                                    <li><i class="icofont-check"></i> Muflas</li>
                                    <li><i class="icofont-check"></i> Batería de mantas Soxhlet de agua</li>
                              </ul>
                          </div>
                          <div class="col-lg-4">
                              <ul class="list-unstyled icons-listing mb-0">
                                    <li><i class="icofont-check"></i> Esterilizador</li>
                                    <li><i class="icofont-check"></i> Batería térmica de Aceite</li>
                                    <li><i class="icofont-check"></i> Batería térmica de arena</li>                                   
                              </ul>
                          </div>     
                      </div>
                      ...
                      <div class="row">
                          <div class="col-lg-4 text-center">
                               <img src="images/equipos-medicos/producto-image056.png" alt="">
                          </div>
                          <div class="col-lg-8">
                               <p>&nbsp;</p>                             
                               <p>La autoclave de ducha de agua LB-10WSA es una unidad horizontal con sistemas de puertas motorizadas o correderas para la esterilización terminal de objetos cargados. Caracterizado con tecnología avanzada de tiempo de temperatura y sistema de control dual F0 para resultados efectivos. Cuenta con tecnología de monitoreo controlado a distancia para una aplicación conveniente.</p>
                          </div>     
                      </div>                          
