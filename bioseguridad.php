...
<html lang="en">
  <head>
    ...
    <title>Equipos Médicos / Bioseguridad / PSS</title>    
          ...
          <div class="col-md-12 ml-auto why-choose wow fadeInRight" data-wow-duration="0" data-wow-delay="0.6s">
              ...
              <section class="bg-white wide-tb-50 bg-wave">
                <div class="container">
                      ...
                      <h3 class="h3-sm fw-6 txt-blue mb-4">PRODUCTOS / EQUIPOS MÉDICOS / BIOSEGURIDAD</h3>  
                      
                      <div class="row">
                          <div class="col-lg-4">  
                              <div class="boxmarcas">
                                 <a href="https://www.labotronics.com/Biosafety-Testing" target="_blank"><img src="images/labotronics.png" alt=""/></a>
                                 <a href="https://www.labotronics.com/Biosafety-Testing" target="_blank" class="btn">Labotronics</a>
                              </div> 
                          </div>
                      ...
                      <div class="row">
                          <div class="col-lg-4">
                               <ul class="list-unstyled icons-listing mb-0">                                    
                                    <li><i class="icofont-check"></i> Cabina de Bioseguridad</li>
                                    <li><i class="icofont-check"></i> Cabina de lavado por flujo de aire</li>
                                    <li><i class="icofont-check"></i> Extractor de Humo</li>
                                    <li><i class="icofont-check"></i> Cabinas Extractoras de Gases</li>                                
                              </ul>
                          </div>
                          <div class="col-lg-4">
                              <ul class="list-unstyled icons-listing mb-0">                                    
                                    <li><i class="icofont-check"></i> Caja de Guantes</li>
                                    <li><i class="icofont-check"></i> Cabina de Flujo Laminar</li>
                                    <li><i class="icofont-check"></i> Sistema exclusa</li>
                                    <li><i class="icofont-check"></i> Cabina de distribución de muestras</li>
                              </ul>
                          </div>
                          <div class="col-lg-4"></div>     
                      </div>
                      ...
                      <div class="row">
                          <div class="col-lg-4 text-center">
                               <img src="images/equipos-medicos/producto-image055.png" alt="">
                          </div>
                          <div class="col-lg-8">
                               <p>&nbsp;</p>
                               <p>El gabinete de bioseguridad de clase II tipo B2 LB-30BSC es un contenedor montado en el piso con 100% de escape de aire. El uso de no volátiles o ligeramente volátiles se revisa mediante un proceso de evaluación de riesgos para la seguridad personal. El sistema de escape del filtro HEPA promueve el desarrollo de un entorno experimentalmente adecuado. Asegura el mismo nivel de protección del producto y del personal.</p>
                          </div>     
                      </div>                          
